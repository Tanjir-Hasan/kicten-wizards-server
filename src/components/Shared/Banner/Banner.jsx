        ...
        <div className="carousel w-11/12 mx-auto">
            ...
            <div id="slide2" className="carousel-item relative w-full">
                <div className='lg:flex items-center'>
                    ...
                    <div className='lg:w-1/2 lg:p-16'>
                        <h4>Pavlova</h4>
                        <p>Regardless of its origin, the pavlova is absolutely delicious! You are most likely able to find a Pavlova in most cake shops or bakeries. You can also buy them pre-made from most major supermarket chains (look in the bread or frozen dessert section).</p>
                    </div>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide3" className="carousel-item relative w-full">
                <div className='lg:flex items-center'>
                    ...
                    <div className='lg:w-1/2 lg:p-16'>
                        <h4>Lamingtons</h4>
                        <p>If you like coconut you’ll love this classic Aussie dessert – The Lamington.
                            <br />
