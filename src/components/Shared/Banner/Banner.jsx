            ...
            <div className="carousel w-full">
                <div id="item1" className="carousel-item w-full mt-4">
                    <div className='lg:flex gap-5 items-center'>
                        <img src="https://i.ibb.co/89W7wny/chicken-parma-commons.jpg" className="lg:ml-20 lg:w-1/2" />
                ...
                <div id="item2" className="carousel-item w-full mt-4">
                    <div className='lg:flex items-center'>
                        <img src="https://i.ibb.co/j5FSYrg/Pavlova-cake-2.jpg" className="lg:ml-20 lg:w-1/2" />
                        <div className='lg:w-1/2 lg:p-16 py-3 px-5'>
                ...
                <div id="item3" className="carousel-item w-full mt-4">
                    <div className='lg:flex items-center'>
                        <img src="https://i.ibb.co/Rzd8mW8/lamington-cake.jpg" className="lg:ml-20 lg:w-1/2" />
                        <div className='lg:w-1/2 lg:p-16 py-3 px-5'>
                ...
                <div id="item4" className="carousel-item w-full mt-4">
                    <div className='lg:flex items-center'>
                        <img src="https://i.ibb.co/vxttp5n/fairy-bread-commons.jpg" className="lg:ml-20 lg:w-1/2" />
                        <div className='lg:w-1/2 lg:p-16 py-3 px-5'>
