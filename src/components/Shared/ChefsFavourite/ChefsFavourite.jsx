...
const ChefsFavourite = () => {
    return (
        <>
            ...
            <div className='px-8'>
                <div className='lg:flex items-center gap-16 border-2 border-[#0F1D22] hover:bg-[#C9AB81] transition duration-300 ease-in-out rounded-lg shadow-xl mb-6 p-4'>
                    ...
                    <p className='lg:border-l-4 border-[#0F1D22] px-3'>This dish is a Spanish delicacy that is loaded with seafood favorites that include mussels, clams, and shrimp. Infused with a rich saffron scent, this dish is loaded with the flavors of Spanish cuisine that is sure to make your mouth water. To enhance its best flavors, cook it on a grill in a large skillet to distribute the flavors evenly.</p>
                </div>
                <div className='lg:flex items-center gap-16 border-2 border-[#0F1D22] hover:bg-[#C9AB81] transition duration-300 ease-in-out rounded-lg shadow-xl mb-6 p-4'>
