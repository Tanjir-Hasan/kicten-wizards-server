...
const ChefsFavourite = () => {
    return (
        <>
            ...
            <div className='px-8'>
                <div className='flex items-center gap-16 border-4 border-[#0F1D22] hover:bg-[#C9AB81] transition duration-300 ease-in-out rounded-lg mb-4 p-4'>
                    <img src="https://i.ibb.co/6n98zq5/f1.webp" alt="" className='h-72' />
                    <h3 className='text-[#193844] font-semibold'>Seafood Paella</h3>
                ...
                <div className='flex items-center gap-16 border-4 border-[#0F1D22] hover:bg-[#C9AB81] transition duration-300 ease-in-out rounded-lg mb-4 p-4'>
                    ...
                    <h3 className='text-[#193844] font-semibold'>Butter Chicken</h3>
                ...
                <div className='flex items-center gap-16 border-4 border-[#0F1D22] hover:bg-[#C9AB81] transition duration-300 ease-in-out rounded-lg mb-4 p-4'>
                    ...
                    <h3 className='text-[#193844] font-semibold'>Pad Thai</h3>
